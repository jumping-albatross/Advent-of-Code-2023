...
# * grid with energized tiles through which a beam has passed

R = len(raw)
C = len(raw[0])

# * starting grid with tiles with spaces and mirrors

TILES = raw

starting_beam = (1, 0, -1, 0) # a beam is (dx, dy, x, y)

tiles_energized = launch_beam(starting_beam)

print(f"Tiles energized = {tiles_energized}")
